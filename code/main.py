...
from problems.cstr_1d import x_dimension as cstr_1d_x_dimension, f as cstr_1d_f, J as cstr_1d_J, plot_states as cstr_1d_plot_states
from problems.cstr_3d import x_dimension as cstr_3d_x_dimension, f as cstr_3d_f, J as cstr_3d_J, plot_states as cstr_3d_plot_states
from problems.test_equation import x_dimension as test_x_dimension, f as test_f, J as test_J, plot_states as test_plot_states
from problems.vanderpol import x_dimension as vanderpol_x_dimension, f as vanderpol_f, J as vanderpol_J, plot_states as vanderpol_plot_states
...
def get_problem(problem):
    if problem == 'test':
        x_dimension, f, J, plotter = test_x_dimension, test_f, test_J, test_plot_states
        x0 = np.array([20])
        params = {'lbd': -1}
